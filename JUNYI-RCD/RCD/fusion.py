...
class Fusion(nn.Module):
    ...
    def forward(self, kn_emb, exer_emb, all_stu_emb):
        ...
        del concat_c_1, concat_c_2, concat_c_3
        del k_from_e_graph, e_k_graph, u_from_e_graph, e_u_graph
        del e_from_u_graph, e_from_k_graph, concat_e_1, concat_e_2
        del score, score1, score2, score3
        del A, B, C, D, k_directed, k_undirected
